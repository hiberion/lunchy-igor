...
public class PrintOrder2 {
  ...
  private static void addContent(Document document) throws DocumentException {
	  ...
	  preface.add(new Paragraph("Организация: " + LunchyMain.options.getProperty("CompanyName"), captFont));
	  addEmptyLine(preface, 1);
	  preface.add(new Paragraph("Телефон: " + LunchyMain.options.getProperty("CompanyPhone"), captFont));
	  addEmptyLine(preface, 1);
	  //preface.add(new Paragraph("Заказ создан: ", captFont));
	  //addEmptyLine(preface, 1);
	  ...
	  if (generalOrderSum >= diffSumm) {
		  double temp = generalOrderSum;
		  generalOrderSum = generalOrderSum - (generalOrderSum * (discountPercent/100.0));
		  Paragraph orderSum = new Paragraph("Total Order sum (Общая сумма заказа): " + String.valueOf(temp), workFont2);
		  Paragraph orderSum2 = new Paragraph("Сумма заказа с учетом скидки: " + String.valueOf(generalOrderSum), workFont2);
		  mainChapter.add(orderSum);
		  mainChapter.add(orderSum2);
	  } else {
